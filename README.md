...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyjuliacall-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyjuliacall-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyjuliacall
# for installing globally
pixi global install pyjuliacall
```
...
It is possible to list all of the versions of `pyjuliacall` available on your platform:
...
```
pixi search pyjuliacall --channel conda-forge
```
